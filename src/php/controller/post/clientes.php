<?php
    ...
    $sqlFilePath = "../../../db/sql/scripts/clientes.sql";
    $api_url = "https://peccin-colplan.ve3.com.br/api/async/channels";
    //$api_url = "https://homo-peccin-colplan.ve3.com.br/api/async/channels";
    ...
    if ($response_data !== null && json_last_error() === JSON_ERROR_NONE) {
        if (isset($response_data['status']) && $response_data['status'] === 202) {
            salvarLog($arquivoLogSuccess, "Sucesso (Clientes): " . json_encode($response_data));
            echo json_encode([
                "success" => true,
            ...
            salvarLog($arquivoLogError, "Erro no retorno da API (Clientes): " . json_encode($response_data));
            echo json_encode([
                "success" => false,
        ...
        salvarLog($arquivoLogError, "Erro ao decodificar JSON de resposta (Clientes): $erroJson");
